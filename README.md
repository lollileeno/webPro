...
### 🔗 Live Demo
* **Public Website:** [https://discover-saudi.onrender.com](https://discover-saudi.onrender.com)
* **Admin Dashboard:** [https://discover-saudi.onrender.com/admin/login.php](https://discover-saudi.onrender.com/admin/login.php)
...
1. **`admin`**: Stores administrative credentials securely.
   * `id` (PK, Serial), `username` (Varchar), `password` (Varchar)
2. **`regions`**: Stores primary geographical locations.
   * `id` (PK, Serial), `name` (Varchar), `description` (Text), `image` (Varchar)
3. **`places`**: Stores specific landmarks mapped to regions.
